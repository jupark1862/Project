				...
				<div class="row">
					...
					<!-- Starts -->
						<ul class="list-unstyled list-inline text-md-right order-info">
							<li class="list-inline-item lead"><i class="fa fa-phone"></i> Call : 001 9876 543 210</li>
							<li class="list-inline-item d-xs-none d-sm-none d-md-inline">&nbsp;</li>
							<li class="list-inline-item"><a href="#" class="btn btn-light animation">Order Food Online!</a></li>
						</ul>
					<!-- Ends -->
					</div>
				</div>
					...
					<ul class="nav navbar-nav text-uppercase text-weight-bold">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu rounded-0 float-md-right">
								<a href="index.html" class="dropdown-item"><i class="fa fa-angle-right"></i> Home</a>
								...
								<a href="contact.html" class="dropdown-item active"><i class="fa fa-angle-right"></i> Contact Us</a>
							</ul>
						</li>
					</ul>
				</div>
                ...
                <!-- Left Column Starts -->
                    <div class="col-md-8 col-sm-12">
                        <div class="contact-left-col">
                            <h5>For any enquiries, please call your nearest office</h5>
                ...
                <!-- Right Column Starts -->
                    <div class="col-md-4 col-sm-12">
                        <div class="contact-right-col">
                            <h5>Contact our customer service</h5>
                            <ul class="list-unstyled">
                                <li class="row">
                                    <div class="col-2"><i class="fa fa-map-marker"></i></div>
                                    <div class="col-10">
                                        <h6>A Unit of Sainath Chillapuram’s and FoodBingo Bvt.Lpt</h6>
                                        <p>
                                            #11-13-999/21 BA Sector-7 Chiran Fort Colony,<br>
                                            Vanastalipuram, LB Nagar, RR Dist,<br>
                                            ( Hyderabad - 500071 ) Telangana, INDIA.
                                        </p>
                                    </div>
                                </li>
                                <li class="row">									
                                    ...
                                    <div class="col-10">
                                        +91-969 956 9999, 960 123 4567
                                    </div>
                                </li>
                                <li class="row">
                                    <div class="col-2"><i class="fa fa-comment"></i></div>
                                    <div class="col-10">
                                        <a href="skype:skypechat.live?chat">Start chat</a>
                                    </div>
                                </li>
                                <li class="row">
                                    <div class="col-2"><i class="fa fa-envelope "></i></div>
                                    <div class="col-10">
                                        <a href="mailto:info@foodbingodomain.com">info@foodbingodomain.com</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
