		...
		<div class="col-lg-9 col-md-8 col-sm-12">
			...
			<div class="hotels-list text-xs-center text-sm-center text-lg-left">
					...
					<div class="float-center list-box-info">
						<c:forEach var="n" items="${list}" begin="0" end="4"
							...
							<h5 class="list-box-info-title">
								<a href="food-details.html">${n.bbsTitle}</a>
							</h5>

							<a href="food-details.html" class="dropdown-item"><i
								class="fa fa-angle-right"></i> ${n.bbsContent}</a>
							...
							<ul class="list-unstyled list-inline list-box-info-links">
								<li class="list-inline-item"><i class="fa fa-info-circle"></i>${n.bbsDate}</li>
								<li class="list-inline-item"><i
									class="fa fa-star-half-full"></i> <a href="">답글(몇개)</a></li>
								<li class="list-inline-item"><i class="fa fa-asterisk"></i>${n.hit}</li>
							</ul>
							</div>
						</c:forEach>
					</div>
				...
				<div class="pagination-block clearfix">
					<ul style="margin: 0 auto;"class="pagination animation float-lg-right">
